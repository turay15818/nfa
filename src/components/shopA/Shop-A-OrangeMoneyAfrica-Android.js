...
function ShopAOrangeMoneyAfricaAndroid() {

  const downloadLocation = "Regent Road";
  const appDownloaded = "Orange Money Africa Android";
  const timestamp = new Date().toISOString();

  fetch("https://heruku-app.herokuapp.com/api/orangeMoneyAfrica-for-shop-A/Android", {
    method: "POST",
...
export default ShopAOrangeMoneyAfricaAndroid;
