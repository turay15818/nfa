...
function ShopCOrangeMoneyAfricaIphone() {

  const downloadLocation = "Kenema";
  const appDownloaded = "Orange Money Africa Iphone";
  const timestamp = new Date().toISOString();

  fetch("https://heruku-app.herokuapp.com/api/orangeMoneyAfrica-for-shop-C/Iphone", {
    method: "POST",
...
export default ShopCOrangeMoneyAfricaIphone;
