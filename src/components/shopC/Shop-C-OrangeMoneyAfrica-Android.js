...
function ShopCOrangeMoneyAfricaAndroid() {

  const downloadLocation = "Kenema";
  const appDownloaded = "Orange Money Africa Android";
  const timestamp = new Date().toISOString();

  fetch("https://heruku-app.herokuapp.com/api/orangeMoneyAfrica-for-shop-C/Android", {
    method: "POST",
...
export default ShopCOrangeMoneyAfricaAndroid;
